...
export const RECIPES: Recipe[] = [
  ...
  { id: 'd11', name: 'Gachas de Chocolate y Coco', category: 'Desayuno', time: '8 min', tags: ['avena', 'dulce fit'], ingredients: [{ item: 'Avena', amount: '50g', category: 'Carb', price: 0.10 }, { item: 'Cacao', amount: '5g', category: 'Other', price: 0.10 }, { item: 'Claras', amount: '100ml', category: 'Protein', price: 0.40 }], steps: ['Mezcla avena, cacao y 200ml agua.', 'Cuece 5 min.', 'Añade claras y remueve hasta que espese.', 'Sirve con coco rallado.'], cheftip: 'El cacao puro amarga; si necesitas dulce añade eritritol.', },
  { id: 'd12', name: 'Pancakes de Avena y Manzana', category: 'Desayuno', time: '15 min', tags: ['avena', 'fruta'], ingredients: [{ item: 'Avena', amount: '40g', category: 'Carb', price: 0.08 }, { item: 'Manzana rallada', amount: '1', category: 'Veggie', price: 0.40 }, { item: 'Huevo', amount: '1', category: 'Protein', price: 0.20 }], steps: ['Mezcla los ingredientes.', 'Deja reposar la masa 5 min.', 'Haz las tortitas a fuego medio en sartén engrasada.', 'Sirve con canela.'], cheftip: 'Rallar la manzana hace la masa mucho más jugosa.', },
  { id: 'd13', name: 'Tostada de Pavo y Queso Crema', category: 'Desayuno', time: '5 min', tags: ['rápido', 'proteico'], ingredients: [{ item: 'Pan Integral', amount: '2', category: 'Carb', price: 0.30 }, { item: 'Pavo lonchas', amount: '4', category: 'Protein', price: 0.80 }, { item: 'Queso crema', amount: '20g', category: 'Other', price: 0.20 }], steps: ['Tuesta el pan.', 'Unta el queso crema.', 'Coloca las lonchas de pavo.', 'Añade pimienta al gusto.'], cheftip: 'Usa pavo con >90% de carne para mejor calidad nutricional.', },
  { id: 'd14', name: 'Bowl de Kéfir y Nueces', category: 'Desayuno', time: '3 min', tags: ['probiótico', 'fresco'], ingredients: [{ item: 'Kéfir Lidl', amount: '200ml', category: 'Protein', price: 0.70 }, { item: 'Nueces Alesto', amount: '30g', category: 'Other', price: 0.50 }, { item: 'Dátiles', amount: '2', category: 'Other', price: 0.20 }], steps: ['Pon el kéfir en un bol.', 'Corta los dátiles en trocitos.', 'Añade las nueces y dátiles.', 'Remueve y disfruta.'], cheftip: 'El kéfir es más ácido que el yogur, ideal para despertar el sistema digestivo.', },
  { id: 'd15', name: 'Huevos Revueltos con Champiñones', category: 'Desayuno', time: '10 min', tags: ['huevos', 'low carb'], ingredients: [{ item: 'Huevos', amount: '3', category: 'Protein', price: 0.60 }, { item: 'Champiñones', amount: '100g', category: 'Veggie', price: 0.50 }], steps: ['Limpia y lamina los champiñones.', 'Saltéalos 5 min en sartén.', 'Añade los huevos batidos y remueve despacio.', 'Sirve caliente.'], cheftip: 'No batas demasiado los huevos para que queden más cremosos.', },
  { id: 'd16', name: 'Gachas Alpinas (con Frutos Secos)', category: 'Desayuno', time: '7 min', tags: ['avena', 'energía'], ingredients: [{ item: 'Avena', amount: '50g', category: 'Carb', price: 0.10 }, { item: 'Leche avena', amount: '200ml', category: 'Other', price: 0.25 }, { item: 'Mix frutos secos', amount: '20g', category: 'Other', price: 0.40 }], steps: ['Cuece la avena en la leche.', 'Cuando esté lista, añade los frutos secos.', 'Endulza con un poco de miel si quieres.', 'Tapa y deja reposar 1 min.'], cheftip: 'Tostar los frutos secos antes potencia mucho el sabor del desayuno.', },
  { id: 'd17', name: 'Smoothie Bowl de Mango Fit', category: 'Desayuno', time: '5 min', tags: ['plátano', 'vitamina'], ingredients: [{ item: 'Plátano', amount: '1', category: 'Other', price: 0.25 }, { item: 'Mango congelado', amount: '100g', category: 'Veggie', price: 1.00 }, { item: 'Proteína neutral', amount: '15g', category: 'Protein', price: 0.40 }], steps: ['Tritura el plátano y el mango con poco líquido.', 'Debe quedar una textura espesa tipo helado.', 'Pasa a un bol.', 'Decora con semillas de cáñamo.'], cheftip: 'Usa poco líquido para que los toppings no se hundan.', },
  { id: 'd18', name: 'Tostada con Requesón y Miel', category: 'Desayuno', time: '4 min', tags: ['tradicional', 'proteico'], ingredients: [{ item: 'Pan Integral', amount: '1', category: 'Carb', price: 0.15 }, { item: 'Requesón Lidl', amount: '80g', category: 'Protein', price: 0.60 }, { item: 'Miel', amount: '10g', category: 'Other', price: 0.15 }], steps: ['Tuesta el pan.', 'Pon una capa generosa de requesón.', 'Añade un hilo de miel por encima.', 'Opcional: un poco de sésamo.'], cheftip: 'El requesón tiene mucha proteína caseína, ideal si desayunas muy temprano.', },
  { id: 'd19', name: 'Porridge de Pera y Jengibre', category: 'Desayuno', time: '10 min', tags: ['avena', 'digestivo'], ingredients: [{ item: 'Avena', amount: '45g', category: 'Carb', price: 0.09 }, { item: 'Pera madura', amount: '1', category: 'Veggie', price: 0.50 }, { item: 'Jengibre', amount: 'pizca', category: 'Other', price: 0.05 }], steps: ['Corta la pera en dados pequeños.', 'Cuece con la avena y el jengibre rallado.', 'Cocina hasta que la pera se deshaga un poco.', 'Sirve caliente.'], cheftip: 'El jengibre ayuda a la digestión si eres sensible a los lácteos matutinos.', },
  { id: 'd20', name: 'Tortilla de Claras y Pavo Ahumado', category: 'Desayuno', time: '7 min', tags: ['clima frío', 'proteína pura'], ingredients: [{ item: 'Claras bote', amount: '200ml', category: 'Protein', price: 0.85 }, { item: 'Pavo Lidl', amount: '50g', category: 'Protein', price: 0.90 }], steps: ['Vierte las claras en la sartén caliente.', 'Pon el pavo en el centro.', 'Dobla con cuidado cuando empiece a cuajar.', 'Cocina 1 min por lado.'], cheftip: 'Añade cebollino fresco al final para un aroma increíble.', },

  { id: 'c11', name: 'Pollo Teriyaki Express', category: 'Comida', time: '12 min', tags: ['pollo', 'asiática'], ingredients: [{ item: 'Pollo tiras', amount: '150g', category: 'Protein', price: 1.10 }, { item: 'Salsa Teriyaki', amount: '20ml', category: 'Other', price: 0.30 }, { item: 'Arroz micro', amount: '1', category: 'Carb', price: 0.55 }], steps: ['Saltea el pollo hasta dorar.', 'Añade la salsa y reduce 2 min.', 'Sirve sobre el arroz caliente.', 'Añade sésamo.'], cheftip: 'Reduce la salsa hasta que brille y se pegue al pollo.', },
  { id: 'c12', name: 'Bowl de Pollo y Boniato', category: 'Comida', time: '30 min', tags: ['pollo', 'boniato', 'fitness'], ingredients: [{ item: 'Pechuga', amount: '180g', category: 'Protein', price: 1.30 }, { item: 'Boniato', amount: '200g', category: 'Carb', price: 0.40 }, { item: 'Brócoli', amount: '100g', category: 'Veggie', price: 0.30 }], steps: ['Corta todo en dados.', 'Hornea o Airfy a 190°C por 20 min.', 'Aliña con aceite y limón.', 'Sirve templado.'], cheftip: 'El boniato asado tiene un índice glucémico menor que el puré.', },
  { id: 'c13', name: 'Ensalada Cesar Fit', category: 'Comida', time: '10 min', tags: ['pollo', 'fresco'], ingredients: [{ item: 'Pollo asado', amount: '120g', category: 'Protein', price: 1.80 }, { item: 'Lechuga Romana', amount: '150g', category: 'Veggie', price: 0.50 }, { item: 'Queso Grana Padano', amount: '10g', category: 'Other', price: 0.40 }], steps: ['Trocea la lechuga y el pollo.', 'Añade el queso rallado.', 'Haz salsa con yogur, limón y anchoa triturada.', 'Mezcla bien.'], cheftip: 'Usa yogur griego en lugar de mayonesa para la salsa Cesar.', },
  { id: 'c14', name: 'Pollo al Ajillo Tradicional Fit', category: 'Comida', time: '15 min', tags: ['pollo', 'tradicional'], ingredients: [{ item: 'Contramuslo deshuesado', amount: '200g', category: 'Protein', price: 1.60 }, { item: 'Ajos Lidl', amount: '5 dientes', category: 'Veggie', price: 0.10 }, { item: 'Vino blanco', amount: '20ml', category: 'Other', price: 0.15 }], steps: ['Dora los ajos enteros.', 'Añade el pollo y sube el fuego.', 'Vierte el vino y deja evaporar 3 min.', 'Cocina hasta secar salsa.'], cheftip: 'No quites la piel si quieres máximo sabor, pero cuenta las grasas.', },
  { id: 'c15', name: 'Wok de Pollo con Anacardos', category: 'Comida', time: '12 min', tags: ['pollo', 'crunchy'], ingredients: [{ item: 'Pollo dados', amount: '150g', category: 'Protein', price: 1.10 }, { item: 'Anacardos Alesto', amount: '15g', category: 'Other', price: 0.45 }, { item: 'Zanahoria', amount: '1', category: 'Veggie', price: 0.15 }], steps: ['Saltea pollo y zanahoria.', 'Añade los anacardos al final.', 'Añade salsa de soja.', 'Revuelve 30 segundos.'], cheftip: 'Tostar los anacardos en el wok les devuelve su textura original.', },
  { id: 'c16', name: 'Pollo Relleno de Espinacas', category: 'Comida', time: '25 min', tags: ['pollo', 'premium'], ingredients: [{ item: 'Pechuga entera', amount: '1', category: 'Protein', price: 1.50 }, { item: 'Espinacas', amount: '50g', category: 'Veggie', price: 0.30 }, { item: 'Queso feta', amount: '20g', category: 'Other', price: 0.40 }], steps: ['Haz un corte lateral en la pechuga.', 'Rellena con espinacas y feta.', 'Cierra con palillos.', 'Cocina a la plancha tapado.'], cheftip: 'Tapar la sartén crea una cámara de vapor que cocina el relleno rápido.', },
  { id: 'c17', name: 'Wraps de Pollo y Hummus', category: 'Comida', time: '8 min', tags: ['pollo', 'hummus', 'rápido'], ingredients: [{ item: 'Tortilla trigo', amount: '2', category: 'Carb', price: 0.40 }, { item: 'Pollo asado', amount: '100g', category: 'Protein', price: 1.50 }, { item: 'Hummus Lidl', amount: '40g', category: 'Other', price: 0.30 }], steps: ['Unta el hummus en las tortillas.', 'Pon el pollo troceado.', 'Añade pepino en láminas.', 'Enrolla apretando bien.'], cheftip: 'Calienta la tortilla 10 seg por lado para que sea más elástica.', },
  { id: 'c18', name: 'Arroz con Pollo y Cúrcuma', category: 'Comida', time: '20 min', tags: ['pollo', 'arroz', 'antiinflamatorio'], ingredients: [{ item: 'Pollo trozos', amount: '150g', category: 'Protein', price: 1.10 }, { item: 'Arroz grano corto', amount: '70g', category: 'Carb', price: 0.15 }, { item: 'Cúrcuma', amount: 'pizca', category: 'Other', price: 0.05 }], steps: ['Dora el pollo con cúrcuma.', 'Añade el arroz y saltea.', 'Vierte el doble de agua cálida.', 'Cuece 15 min hasta secar.'], cheftip: 'Añade pimienta negra junto a la cúrcuma para activar la curcumina.', },
  { id: 'c19', name: 'Albóndigas de Pollo Caseras', category: 'Comida', time: '25 min', tags: ['pollo', 'meal prep'], ingredients: [{ item: 'Picada de pollo', amount: '200g', category: 'Protein', price: 1.60 }, { item: 'Huevo', amount: '1', category: 'Protein', price: 0.20 }, { item: 'Salsa tomate', amount: '100ml', category: 'Veggie', price: 0.30 }], steps: ['Mezcla carne y huevo.', 'Forma bolas pequeñas.', 'Dóralas en sartén.', 'Añade tomate y cocina 10 min.'], cheftip: 'Usa poco pan rallado para que no suban los carbos.', },
  { id: 'c20', name: 'Pollo Gratinado con Mozzarella', category: 'Comida', time: '15 min', tags: ['pollo', 'queso'], ingredients: [{ item: 'Filetes pollo', amount: '150g', category: 'Protein', price: 1.10 }, { item: 'Mozzarella light', amount: '40g', category: 'Other', price: 0.50 }, { item: 'Orégano', amount: 'pizca', category: 'Other', price: 0.05 }], steps: ['Haz el pollo a la plancha.', 'Pon el queso encima el último min.', 'Tapa para que funda.', 'Sirve con ensalada.'], cheftip: 'La mozzarella light funde muy bien y reduce las grasas a la mitad.', },

  { id: 'a4', name: 'Snack de Queso y Pavo', category: 'Almuerzo', time: '2 min', tags: ['queso', 'proteína'], ingredients: [{ item: 'Queso en lonchas', amount: '2', category: 'Protein', price: 0.40 }, { item: 'Pavo', amount: '2 lonchas', category: 'Protein', price: 0.40 }], steps: ['Enrolla el pavo dentro del queso.', 'Come directamente.'], cheftip: 'Ideal si estás en la oficina y no tienes tiempo de nada.', },
  { id: 'a5', name: 'Puñado de Almendras Alesto', category: 'Almuerzo', time: '1 min', tags: ['frutos secos', 'grasas'], ingredients: [{ item: 'Almendras', amount: '30g', category: 'Other', price: 0.60 }], steps: ['Contar 20 almendras.', 'Disfrutar.'], cheftip: 'Cuidado con la cantidad, son muy densas calóricamente.', },
  { id: 'a6', name: 'Tortita de Arroz con Atún', category: 'Almuerzo', time: '3 min', tags: ['atún', 'rápido'], ingredients: [{ item: 'Tortita arroz', amount: '2', category: 'Carb', price: 0.20 }, { item: 'Atún natural', amount: '1 lata', category: 'Protein', price: 0.80 }], steps: ['Escurre el atún.', 'Ponlo sobre las tortitas.', 'Añade un poco de sal.'], cheftip: 'Añade una gota de tabasco si te gusta el picante.', },
  { id: 'a8', name: 'Queso Batido con Canela', category: 'Almuerzo', time: '2 min', tags: ['queso', 'proteína'], ingredients: [{ item: 'Queso fresco batido', amount: '200g', category: 'Protein', price: 0.60 }, { item: 'Canela', amount: 'pizca', category: 'Other', price: 0.05 }], steps: ['Poner en un bol.', 'Mezclar con canela.', 'Batir bien.'], cheftip: 'La canela sacia el hambre de dulce sin añadir calorías.', },
  { id: 'a9', name: 'Bebida Proteica Milbona', category: 'Almuerzo', time: '1 min', tags: ['proteína', 'líquido'], ingredients: [{ item: 'Batido chocolate', amount: '1 unidad', category: 'Protein', price: 0.95 }], steps: ['Agitar.', 'Beber muy frío.'], cheftip: 'Tiene 35g de proteína, una de las mejores del Lidl.', },

  { id: 'm6', name: 'Brocheta de Tomate y Mozzarella', category: 'Merienda', time: '5 min', tags: ['fresco', 'mediterráneo'], ingredients: [{ item: 'Tomates cherry', amount: '6', category: 'Veggie', price: 0.40 }, { item: 'Mini mozzarella', amount: '6', category: 'Protein', price: 0.80 }], steps: ['Pincha un tomate y una bola.', 'Repite hasta llenar brocheta.', 'Añade albahaca.'], cheftip: 'Es el snack perfecto para evitar picar galletas por la tarde.', },
  { id: 'm10', name: 'Crepe Fit de Avena', category: 'Merienda', time: '10 min', tags: ['avena', 'merienda fit'], ingredients: [{ item: 'Claras', amount: '100ml', category: 'Protein', price: 0.40 }, { item: 'Harina de avena', amount: '20g', category: 'Carb', price: 0.05 }], steps: ['Mezcla muy bien.', 'Vierte en sartén grande extendiendo.', 'Cocina 1 min por lado.', 'Rellena con lo que quieras.'], cheftip: 'Para que no se pegue la sartén debe estar bien caliente al principio.', },
  { id: 'm11', name: 'Gelatina de Proteína Mix', category: 'Merienda', time: '2 min', tags: ['proteína', 'bajo kcal'], ingredients: [{ item: 'Gelatina 0%', amount: '1', category: 'Other', price: 0.40 }, { item: 'Queso freso', amount: '50g', category: 'Protein', price: 0.20 }], steps: ['Mezcla ambos en un bol.', 'Machaca con cuchara.', 'Disfruta frío.'], cheftip: 'Parece un postre de restaurante pero es pura proteína.', },
  { id: 'm12', name: 'Plátano Choco-Peanut', category: 'Merienda', time: '5 min', tags: ['plátano', 'dulce'], ingredients: [{ item: 'Plátano', amount: '1', category: 'Other', price: 0.25 }, { item: 'Choco 85%', amount: '1 onza', category: 'Other', price: 0.20 }], steps: ['Derrite el chocolate.', 'Baña el plátano.', 'Espolvorea cacahuete.'], cheftip: 'El chocolate 85% tiene antioxidantes que benefician el corazón.', },
  { id: 'm13', name: 'Bowl de Avena y Frambuesa', category: 'Merienda', time: '5 min', tags: ['avena', 'fresco'], ingredients: [{ item: 'Copos avena', amount: '25g', category: 'Carb', price: 0.05 }, { item: 'Leche coco', amount: '100ml', category: 'Other', price: 0.40 }, { item: 'Frambuesas', amount: '30g', category: 'Veggie', price: 0.70 }], steps: ['Remoja la avena en la leche fría.', 'Añade frambuesas.', 'Aplasta una frambuesa para teñir la leche.'], cheftip: 'La frambuesa tiene mucha fibra, ideal para llegar a la cena saciado.', },

  { id: 'e6', name: 'Ensalada de Atún y Huevo', category: 'Cena', time: '5 min', tags: ['atún', 'huevos', 'rápido'], ingredients: [{ item: 'Atún natural', amount: '2 latas', category: 'Protein', price: 1.60 }, { item: 'Huevo cocido', amount: '1', category: 'Protein', price: 0.20 }, { item: 'Mezclum', amount: 'bolsa', category: 'Veggie', price: 0.80 }], steps: ['Pon la lechuga en un bol.', 'Añade atún y el huevo cortado.', 'Aliña con vinagre.'], cheftip: 'Compra latas en pack para ahorrar dinero en tu lista.', },
  { id: 'e16', name: 'Sopa de Pollo y Fideos Finos', category: 'Cena', time: '15 min', tags: ['pollo', 'confort'], ingredients: [{ item: 'Caldo pollo', amount: '400ml', category: 'Other', price: 0.80 }, { item: 'Pollo restos', amount: '50g', category: 'Protein', price: 0.50 }, { item: 'Fideos', amount: '20g', category: 'Carb', price: 0.10 }], steps: ['Hierve el caldo.', 'Añade fideos y cocina 3 min.', 'Pon el pollo troceado al final.', 'Añade una hoja de hierbabuena.'], cheftip: 'La hierbabuena le da el toque de sopa de abuela madrileña.', },
  { id: 'e17', name: 'Tortilla Francesa de Atún', category: 'Cena', time: '6 min', tags: ['huevos', 'atún'], ingredients: [{ item: 'Huevos', amount: '2', category: 'Protein', price: 0.40 }, { item: 'Atún lata', amount: '1', category: 'Protein', price: 0.80 }], steps: ['Bate huevos.', 'Añade el atún bien escurrido.', 'Cocina la tortilla.', 'No cuajes demasiado el centro.'], cheftip: 'Escurre el aceite del atún para ahorrar hasta 150 kcal por lata.', },
  { id: 'e18', name: 'Pechuga a la Plancha "Juicy"', category: 'Cena', time: '10 min', tags: ['pollo', 'básico'], ingredients: [{ item: 'Filete pechuga', amount: '180g', category: 'Protein', price: 1.30 }, { item: 'Especias pollo', amount: 'pizca', category: 'Other', price: 0.05 }], steps: ['Pon sartén a tope.', 'Echa el pollo y no lo muevas 2 min.', 'Dale la vuelta y apaga el fuego.', 'Deja que se termine con calor residual.'], cheftip: 'El calor residual es la clave para que la pechuga no sea "suela de zapato".', },
  { id: 'e19', name: 'Calabacines Rellenos de Pavo', category: 'Cena', time: '20 min', tags: ['pavo', 'vegetal', 'horno'], ingredients: [{ item: 'Calabacín', amount: '1 grande', category: 'Veggie', price: 0.50 }, { item: 'Picada pavo', amount: '100g', category: 'Protein', price: 0.90 }], steps: ['Corta el calabacín a lo largo.', 'Vacía con cuchara.', 'Mezcla pulpa con pavo y cocina 5 min.', 'Rellena y gratina 10 min.'], cheftip: 'Usa el horno a máxima potencia solo para gratinar al final.', },
  { id: 'e20', name: 'Poke de Salmon y Aguacate', category: 'Cena', time: '10 min', tags: ['salmón', 'premium', 'fresco'], ingredients: [{ item: 'Salmón dados', amount: '100g', category: 'Protein', price: 2.50 }, { item: 'Aguacate', amount: '1/2', category: 'Veggie', price: 0.60 }, { item: 'Arroz micro', amount: '0.5', category: 'Carb', price: 0.30 }], steps: ['Pon el arroz de base.', 'Coloca salmón y aguacate encima.', 'Añade semillas de sésamo.', 'Aliña con soja.'], cheftip: 'Congela el salmón 48h antes por seguridad alimentaria (anisakis).', },
  { id: 'e21', name: 'Entrecot de Ternera a la Plancha', category: 'Cena', time: '8 min', tags: ['ternera', 'premium', 'hierro'], ingredients: [{ item: 'Entrecot pieza', amount: '200g', category: 'Protein', price: 4.50 }, { item: 'Sal gorda', amount: 'pizca', category: 'Other', price: 0.05 }], steps: ['Atempera la carne 30 min fuera de nevera.', 'Sartén muy caliente.', 'Cocina 2 min por lado.', 'Echa la sal al final.'], cheftip: 'Nunca pinches la carne para darle la vuelta, usa pinzas o se saldrán los jugos.', },
  { id: 'e22', name: 'Tortilla de Patata Microondas Fit', category: 'Cena', time: '15 min', tags: ['huevos', 'tradicional'], ingredients: [{ item: 'Patatas', amount: '200g', category: 'Carb', price: 0.40 }, { item: 'Huevos', amount: '3', category: 'Protein', price: 0.60 }], steps: ['Pica patata fina.', 'Cocina en micro 7 min con un poco de agua.', 'Mezcla con huevos batidos.', 'Cuaja en sartén 1 min por lado.'], cheftip: 'Cocinar la patata al micro ahorra el 80% de las calorías del aceite frito.', },
  { id: 'e23', name: 'Burrito de Pavo y Queso', category: 'Cena', time: '5 min', tags: ['pavo', 'rápido'], ingredients: [{ item: 'Tortilla integral', amount: '1', category: 'Carb', price: 0.20 }, { item: 'Fiambre pavo 95%', amount: '100g', category: 'Protein', price: 1.50 }], steps: ['Pon el pavo en la tortilla.', 'Añade queso ligero.', 'Dobla y tuesta en la sartén 30 seg.', 'Come caliente.'], cheftip: 'Tostar el burrito lo mantiene cerrado sin necesidad de palillos.', },
  { id: 'e24', name: 'Brochetas de Pavo y Piña', category: 'Cena', time: '12 min', tags: ['pavo', 'exótico'], ingredients: [{ item: 'Pavo dados', amount: '150g', category: 'Protein', price: 1.20 }, { item: 'Piña natural', amount: '2 rodajas', category: 'Veggie', price: 0.40 }], steps: ['Alterna trozos de pavo y piña en el palo.', 'Cocina a la plancha.', 'Pincela con un poco de soja.'], cheftip: 'La enzima de la piña (bromelina) ayuda a digerir la proteína del pavo.', },
  { id: 'e25', name: 'Crema de Calabacín y Quesitos', category: 'Cena', time: '15 min', tags: ['vegetal', 'caliente', 'ligero'], ingredients: [{ item: 'Calabacín', amount: '2', category: 'Veggie', price: 0.80 }, { item: 'Quesitos light', amount: '2', category: 'Protein', price: 0.25 }], steps: ['Hierve calabacín 10 min con poca agua.', 'Retira la mitad del agua.', 'Añade quesitos y tritura.', 'Sirve caliente.'], cheftip: 'No quites la piel del calabacín para que la crema sea verde intenso y con fibra.', },
  { id: 'e26', name: 'Wok de Ternera y Zanahoria', category: 'Cena', time: '10 min', tags: ['ternera', 'rápido'], ingredients: [{ item: 'Ternera tiras', amount: '150g', category: 'Protein', price: 2.10 }, { item: 'Zanahoria rallada', amount: '100g', category: 'Veggie', price: 0.30 }], steps: ['Saltea zanahoria 3 min.', 'Añade ternera y cocina 2 min alto fuego.', 'Mezcla con soja.', 'Disfruta.'], cheftip: 'La zanahoria rallada se cocina casi instantáneamente en el wok.', },
  { id: 'e27', name: 'Ensalada de Espinacas y Nueces', category: 'Cena', time: '5 min', tags: ['fresco', 'vegetariano'], ingredients: [{ item: 'Espinacas frescas', amount: '100g', category: 'Veggie', price: 0.50 }, { item: 'Nueces', amount: '20g', category: 'Other', price: 0.35 }], steps: ['Lava las espinacas.', 'Añade las nueces troceadas.', 'Aliña con módena.', 'Añade pasas si quieres.'], cheftip: 'El vinagre de módena es dulce, úsalo con moderación por el azúcar.', },
  { id: 'e28', name: 'Pavo a la Pimienta con Judías', category: 'Cena', time: '15 min', tags: ['pavo', 'judías'], ingredients: [{ item: 'Filete pavo', amount: '150g', category: 'Protein', price: 1.20 }, { item: 'Judías verdes lata', amount: '150g', category: 'Veggie', price: 0.60 }], steps: ['Cocina el pavo con mucha pimienta.', 'Añade las judías a la sartén 2 min.', 'Sirve todo junto.', 'Añade un poco de pimentón.'], cheftip: 'Las judías de bote son una solución rápida y nutritiva para cenas de 5 min.', },
  { id: 'e29', name: 'Tortilla de Champiñones y Perejil', category: 'Cena', time: '10 min', tags: ['huevos', 'champi'], ingredients: [{ item: 'Huevos', amount: '2', category: 'Protein', price: 0.40 }, { item: 'Champiñones laminados', amount: '100g', category: 'Veggie', price: 0.50 }], steps: ['Dora los champis con ajo y perejil.', 'Echa el huevo batido.', 'Dobla y sirve.', 'Queda muy aromática.'], cheftip: 'Perejil fresco siempre al final para que no pierda color.', },
  { id: 'e30', name: 'Brochetas de Gambas y Calabacín', category: 'Cena', time: '10 min', tags: ['pescado', 'light'], ingredients: [{ item: 'Gambas', amount: '100g', category: 'Protein', price: 1.80 }, { item: 'Calabacín dados', amount: '100g', category: 'Veggie', price: 0.25 }], steps: ['Monta las brochetas.', 'Haz a la plancha con limón.', 'Sazona con ajo en polvo.', 'Sirve con ensalada.'], cheftip: 'Si usas palitos de madera, mójalos 5 min antes para que no se quemen.', },
];
